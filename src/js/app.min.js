...
$('#slidebar-menu a').click(function() {
	console.log('quitalo')
	$('#menu-off-canvas').toggleClass('sb-active')
	// $('#menu-off-canvas').toggleClass('sb-active')
})

// <div class="ms-slidebar sb-slidebar sb-left sb-momentum-scrolling sb-style-overlay" id="menu-off-canvas" style="margin-left: -300px;">

// <div class="ms-slidebar sb-slidebar sb-left sb-momentum-scrolling sb-style-overlay sb-active" id="menu-off-canvas" style="margin-left: -300px; transform: translate(300px);">